...
### 简短介绍（30 字以内）
```
专业视频监控与推流工具。支持多摄像头、RTMP/RTSP/SRT推流、高清录制、中英双语。
```
...
一款功能强大的 Android 视频监控与直播推流工具，支持多摄像头管理、实时预览、高清录制和多协议推流。

📹 核心功能：
• 多摄像头支持：前后摄像头同时或单独使用，一键切换
• 实时预览：流畅的摄像头实时画面预览
• 高清录制：支持单摄/双摄同步录制，后台持续录制
• 多协议推流：支持 RTMP、RTSP、SRT、UDP 主流推流协议
• 直接模式：P2P 点对点传输，无需服务器即可观看
• 拉流播放：支持 RTMP/RTSP/HLS/DASH 多种流媒体格式播放
• 时间水印：录制视频自动添加时间戳水印
...
🛠️ 技术特性：
• 采用 CameraX 现代化摄像头框架
• Media3 ExoPlayer 专业级播放引擎
• RootEncoder 高效音视频编码
• Material Design 3 现代界面设计
• 支持 Android 8.0 及以上版本

📋 适用场景：
✓ 家庭安防监控
✓ 直播推流到 OBS/YouTube/斗鱼等平台
✓ 视频会议录制
✓ 远程视频监控
✓ 教育培训录像
✓ 产品展示直播
...
### 关键词（标签）
```
摄像头, 监控, 录制, 推流, RTMP, RTSP, 直播, 视频, 前后双摄, 摄影工具, 安防, SRT
```
